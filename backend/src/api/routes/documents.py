...
from src.config import settings  # noqa: F401 – UPLOAD_MAX_SIZE_MB
from src.database import get_db
from src.models.db import DocumentDomainMap, KnowledgeDomain, MicroModule, SourceDocument
from src.models.schemas import DocumentResponse, DocumentListResponse, DocumentUploadResponse
from src.services.content_filter import check_prompt_injection, sanitize_for_prompt
...
async def _shred_sync(db: AsyncSession, doc_id: int, raw_text: str, domain_names: List[str]) -> None:
